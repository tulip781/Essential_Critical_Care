ActiveAdmin.register Infographic do
  ...
  permit_params :title, :sub_category_id, :category_id, :secret_category_id, :secret_sub_category_id, :english?, :pinned?, :photo
  form do |f|
    ...
    f.inputs "Select One of these to attach Infographic or Poster to" do
